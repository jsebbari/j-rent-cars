...
// ______________ functions _____________ 
  ...
  >
      ...
      <div className="Navigation" >
        ...
        <NavLink activeclassname="active"  className ="connect-user-link" to="/connexion" >  <FaRegUserCircle size={25}style={{marginRight:'.5rem'}} className="user-connect-icon"/> <span className="connect-user-text">{currentUser?"Mon compte": "Se connecter | S'inscrire"}</span> </NavLink>
